          ...
          <div class="card-body">
            ...
            <form id="register-form" action="register.php" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="telNo" name="telNo" placeholder="Enter your telephone number" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="age" name="age" placeholder="Enter the patient's age" required>
              </div>
              <div class="mb-3">
